(function () {
  ...
  const translations = {
    zh: {
      ...
      scoringMethodBody: "每位选手逐场应用徽标与指导员称号加成；双人战旗在同一场比赛中先取二人平均。“系列赛最佳地图”在 Bo2、Bo3 中取最高两场，在 Bo5 中取最高三场，再选择全结算期得分最高的系列赛；“全部地图平均 ×2”对全结算期所有有效地图取平均并乘二，不再逐系列赛择优。手动倍率模式会完全替代徽标品质与特性的倍率。",
    ...
    en: {
      ...
      scoringMethodBody: "Each player is scored map by map with emblem and advisor-title bonuses. Two-player banners first average both players within the same map. Best Series Maps takes the top two maps in a Bo2 or Bo3 and the top three maps in a Bo5, then keeps the highest-scoring series in the period; All-Map Average ×2 averages every valid map in the full scoring period and doubles it without selecting a best series. Manual multiplier mode completely replaces quality and trait multipliers.",
